...
Плагин для серверов Minecraft на Paper 1.21+, который позволяет улучшать печки за внутриигровую валюту через CoinsEngine.
...
Плагин написан на Java 21 с использованием:
- Paper API 1.21+
